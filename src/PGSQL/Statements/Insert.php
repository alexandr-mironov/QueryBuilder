...
namespace QueryBuilder\PGSQL\Statements;

use QueryBuilder\Expression;
use QueryBuilder\Statements\Insert as InsertStatement;
use QueryBuilder\Statements\StatementInterface;

/**
 * Class Insert
 *
 * @package QueryBuilder\PGSQL\Statements
 */
